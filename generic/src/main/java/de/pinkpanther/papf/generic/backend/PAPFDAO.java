 ...
 */
 public interface PAPFDAO<T extends PAPFEntity> extends JpaRepository<T, Long> {
    ...
    @Override
    @Nonnull
     <S extends T> List<S> findAll(@Nonnull final Example<S> example, @Nonnull Sort sort);
     ...
     */
    @Override
     <S extends T> boolean exists(@Nonnull final Example<S> example);
}